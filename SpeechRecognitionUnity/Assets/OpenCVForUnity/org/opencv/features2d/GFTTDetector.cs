...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class GFTTDetector : Feature2D
    {
        ...
        [DllImport (LIBNAME)]
        private static extern IntPtr features2d_GFTTDetector_create_11 (int maxCorners, double qualityLevel, double minDistance, int blockSize, int gradiantSize, bool useHarrisDetector);
        ...
        // C++: static Ptr_GFTTDetector cv::GFTTDetector::create(int maxCorners = 1000, double qualityLevel = 0.01, double minDistance = 1, int blockSize = 3, bool useHarrisDetector = false, double k = 0.04)
        [DllImport (LIBNAME)]
        private static extern IntPtr features2d_GFTTDetector_create_13 (int maxCorners, double qualityLevel, double minDistance, int blockSize, bool useHarrisDetector, double k);

        [DllImport (LIBNAME)]
        private static extern IntPtr features2d_GFTTDetector_create_14 (int maxCorners, double qualityLevel, double minDistance, int blockSize, bool useHarrisDetector);

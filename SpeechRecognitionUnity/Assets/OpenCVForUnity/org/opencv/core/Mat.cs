...
#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IOS || UNITY_WEBGL) && !UNITY_EDITOR) || UNITY_5 || UNITY_5_3_OR_NEWER
            Mat retVal = new Mat(core_Mat_n_1reshape_11(nativeObj, cn, newshape.Length, newshape));
 ...
 */
        ...
        // C++: Mat Mat::reshape(int cn, int newndims, const int* newsz)
        [DllImport (LIBNAME)]
        private static extern IntPtr core_Mat_n_1reshape_11 (IntPtr nativeObj, int cn, int newndims, int[] newsz);

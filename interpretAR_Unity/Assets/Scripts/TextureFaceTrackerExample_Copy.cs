...
public class TextureFaceTrackerExample_Copy : MonoBehaviour
{
    ///<summary>
...
//            }
    ...
    void ActionPerformer(string command)
    {
        ...
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("why_right", -1);
        }

        if (command.Contains("where"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("where_right", -1);
        }


        if (command.Contains("apple"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("apple_right", -1);
        }

        if (command.Contains("boy"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("boy_right", -1);
        }
   
        if (command.Contains("cat"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("cat_right", -1);
        }

        if (command.Contains("dog"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("dog_right", -1);
        }

        if (command.Contains("eat"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("eat_right", -1);
        }

        if (command.Contains("how"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("how_right", -1);
            GameObject.FindGameObjectWithTag("left hand").GetComponent<Animator>().CrossFade("how_left", -1);
        }

        if (command.Contains("okay"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("ok_right", -1);
        }
        ...
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("angry_right", -1);
            GameObject.FindGameObjectWithTag("left hand").GetComponent<Animator>().CrossFade("angry_left", -1);
        }

        if (command.Contains("more"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("more_right", -1);
            GameObject.FindGameObjectWithTag("left hand").GetComponent<Animator>().CrossFade("more_left", -1);
        }

        if (command.Contains("who"))
        {
            GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("who_right", -1);
        }
        //resultText.text = "Say something :-)";
        //SpeechRecognizer.StartRecording(true);
    }

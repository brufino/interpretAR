...
base.Dispose (disposing);
        ...
        [DllImport (LIBNAME)]
        private static extern IntPtr xfeatures2d_LATCH_create_11 (int bytes, bool rotationInvariance, int half_ssd_size);
        [DllImport (LIBNAME)]
        private static extern IntPtr xfeatures2d_LATCH_create_12 (int bytes, bool rotationInvariance);
        [DllImport (LIBNAME)]

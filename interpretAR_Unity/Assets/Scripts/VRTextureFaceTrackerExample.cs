...
public class VRTextureFaceTrackerExample : MonoBehaviour
{
    ///<summary>
...
//            }
    ...
    public void OnFinalResult(string result)
    {
        ...
        resultText.text = result;
        FullSentenceActionPerformer(result);
        //word = result;
        //ActionPerformer(result);
    ...
    public void OnPartialResult(string result)
    {
        ...
        // // writes text on a partial result (for single word ASL)
        // resultText.text = result;
        // SingleWordActionPerformer(result);
    }
    ...
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("why", -1);
    //     }

    //     if (command.Contains("where"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("where", -1);
    //     }


    //     if (command.Contains("apple"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("apple", -1);
    //     }

    //     if (command.Contains("boy"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("boy", -1);
    //     }
   
    //     if (command.Contains("cat"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("cat", -1);
    //     }

    //     if (command.Contains("dog"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("dog", -1);
    //     }

    //     if (command.Contains("eat"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("eat", -1);
    //     }

    //     if (command.Contains("how"))
    //     {
    //         GameObject.FindGameObjectWithTag("left hand").GetComponent<Animator>().CrossFade("how", -1);
    //     }

    //     if (command.Contains("okay"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("ok", -1);
    //     }

    //     if (command.Contains("what"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("what_right", -1);
    //         GameObject.FindGameObjectWithTag("left hand").GetComponent<Animator>().CrossFade("what_left", -1);
    //     }

    //     if (command.Contains("when"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("when_right", -1);
    //         GameObject.FindGameObjectWithTag("left hand").GetComponent<Animator>().CrossFade("when_left", -1);
    //     }

    //     if (command.Contains("who"))
    //     {
    //         GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade("who", -1);
    //     }
    //     //resultText.text = "Say something :-)";
    //     //SpeechRecognizer.StartRecording(true);
    // }
    ...
    static Hashtable CreateASLvocabRight() 
    {
        ...
        string[] vocab_list_right = {"apple", "boy", "cat", "dog", "eat", "how", "okay", "what", "when", "who"};
    ...
    static Hashtable CreateASLvocabLeft() 
    {
        ...
        // list of all ASL words available 
        string[] vocab_list_left = {"what", "when"};
    ...
    // // THEORY: THE FULL SENTENCE ACTION PERFORMER SHOULD WORK WITH SINGLE WORD AS WELL? 
    // // TEST BOTH FULL SENTENCE AND SINGLE WORD!!!

    // // does single word ASL 
    // void SingleWordActionPerformer(string command)
    // {
    //     if (ASLvocab.ContainsKey(command))
    //     {
    //         GameObject.FindGameObjectWithTag("(twohand)").GetComponent<Animator>().CrossFade(command, -1);
    //     }
    // }

    // does full sentence ASL 
    // checks if each word is in the ASL vocab list, if so plays it, if not goes onto next word. 
    void FullSentenceActionPerformer(string sentence) { 
        ...
        for (int i=0; i < word_array.Length; i++) 
        {
            ...
            if (ASL_vocab_right.ContainsKey(word))
            {    
                GameObject.FindGameObjectWithTag("right hand").GetComponent<Animator>().CrossFade(word, -1);
            }
            else if (ASL_vocab_left.ContainsKey(word))
            {
                GameObject.FindGameObjectWithTag("left hand").GetComponent<Animator>().CrossFade(word, -1);

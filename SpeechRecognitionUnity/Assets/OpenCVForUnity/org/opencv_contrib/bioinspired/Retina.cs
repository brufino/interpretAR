...
Size retVal = new Size (tmpArray);
        ...
        [DllImport (LIBNAME)]
        private static extern IntPtr bioinspired_Retina_create_11 (double inputSize_width, double inputSize_height, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor);
        [DllImport (LIBNAME)]
        private static extern IntPtr bioinspired_Retina_create_12 (double inputSize_width, double inputSize_height, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling);
        [DllImport (LIBNAME)]
        private static extern IntPtr bioinspired_Retina_create_13 (double inputSize_width, double inputSize_height, bool colorMode, int colorSamplingMethod);
        [DllImport (LIBNAME)]
        private static extern IntPtr bioinspired_Retina_create_14 (double inputSize_width, double inputSize_height, bool colorMode);
        ...
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setColorSaturation_11 (IntPtr nativeObj, bool saturateColors);
        [DllImport (LIBNAME)]
        ...
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupIPLMagnoChannel_11 (IntPtr nativeObj, bool normaliseOutput, float parasolCells_beta, float parasolCells_tau, float parasolCells_k, float amacrinCellsTemporalCutFrequency, float V0CompressionParameter, float localAdaptintegration_tau);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupIPLMagnoChannel_12 (IntPtr nativeObj, bool normaliseOutput, float parasolCells_beta, float parasolCells_tau, float parasolCells_k, float amacrinCellsTemporalCutFrequency, float V0CompressionParameter);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupIPLMagnoChannel_13 (IntPtr nativeObj, bool normaliseOutput, float parasolCells_beta, float parasolCells_tau, float parasolCells_k, float amacrinCellsTemporalCutFrequency);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupIPLMagnoChannel_14 (IntPtr nativeObj, bool normaliseOutput, float parasolCells_beta, float parasolCells_tau, float parasolCells_k);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupIPLMagnoChannel_15 (IntPtr nativeObj, bool normaliseOutput, float parasolCells_beta, float parasolCells_tau);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupIPLMagnoChannel_16 (IntPtr nativeObj, bool normaliseOutput, float parasolCells_beta);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupIPLMagnoChannel_17 (IntPtr nativeObj, bool normaliseOutput);
        [DllImport (LIBNAME)]
        ...
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupOPLandIPLParvoChannel_11 (IntPtr nativeObj, bool colorMode, bool normaliseOutput, float photoreceptorsLocalAdaptationSensitivity, float photoreceptorsTemporalConstant, float photoreceptorsSpatialConstant, float horizontalCellsGain, float HcellsTemporalConstant, float HcellsSpatialConstant);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupOPLandIPLParvoChannel_12 (IntPtr nativeObj, bool colorMode, bool normaliseOutput, float photoreceptorsLocalAdaptationSensitivity, float photoreceptorsTemporalConstant, float photoreceptorsSpatialConstant, float horizontalCellsGain, float HcellsTemporalConstant);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupOPLandIPLParvoChannel_13 (IntPtr nativeObj, bool colorMode, bool normaliseOutput, float photoreceptorsLocalAdaptationSensitivity, float photoreceptorsTemporalConstant, float photoreceptorsSpatialConstant, float horizontalCellsGain);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupOPLandIPLParvoChannel_14 (IntPtr nativeObj, bool colorMode, bool normaliseOutput, float photoreceptorsLocalAdaptationSensitivity, float photoreceptorsTemporalConstant, float photoreceptorsSpatialConstant);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupOPLandIPLParvoChannel_15 (IntPtr nativeObj, bool colorMode, bool normaliseOutput, float photoreceptorsLocalAdaptationSensitivity, float photoreceptorsTemporalConstant);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupOPLandIPLParvoChannel_16 (IntPtr nativeObj, bool colorMode, bool normaliseOutput, float photoreceptorsLocalAdaptationSensitivity);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupOPLandIPLParvoChannel_17 (IntPtr nativeObj, bool colorMode, bool normaliseOutput);
        [DllImport (LIBNAME)]
        private static extern void bioinspired_Retina_setupOPLandIPLParvoChannel_18 (IntPtr nativeObj, bool colorMode);
        [DllImport (LIBNAME)]

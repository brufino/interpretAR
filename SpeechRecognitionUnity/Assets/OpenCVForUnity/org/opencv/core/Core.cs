...
namespace OpenCVForUnity.CoreModule
{
    ...
    public class Core
    {
        ...
        private static string getVersion () { return "4.0.0-dev"; }
...
Scalar retVal = new Scalar (tmpArray);
    ...
    return res;
        ...
        // C++:  String cv::samples::findFile(String relative_path, bool required = true, bool silentMode = false)
        [DllImport (LIBNAME)]
        private static extern IntPtr core_Core_findFile_10 (string relative_path, bool required, bool silentMode);
        [DllImport (LIBNAME)]
        private static extern IntPtr core_Core_findFile_11 (string relative_path, bool required);
        [DllImport (LIBNAME)]
        private static extern IntPtr core_Core_findFile_12 (string relative_path);

        // C++:  String cv::samples::findFileOrKeep(String relative_path, bool silentMode = false)
        [DllImport (LIBNAME)]
        private static extern IntPtr core_Core_findFileOrKeep_10 (string relative_path, bool silentMode);
        [DllImport (LIBNAME)]
        ...
        [DllImport (LIBNAME)]
        private static extern bool core_Core_checkRange_11 (IntPtr a_nativeObj, bool quiet, double minVal);
        [DllImport (LIBNAME)]
        private static extern bool core_Core_checkRange_12 (IntPtr a_nativeObj, bool quiet);
        [DllImport (LIBNAME)]
        ...
        [DllImport (LIBNAME)]
        private static extern void core_Core_mulTransposed_12 (IntPtr src_nativeObj, IntPtr dst_nativeObj, bool aTa, IntPtr delta_nativeObj);
        [DllImport (LIBNAME)]
        private static extern void core_Core_mulTransposed_13 (IntPtr src_nativeObj, IntPtr dst_nativeObj, bool aTa);
        ...
        // C++:  void cv::ipp::setUseIPP_NotExact(bool flag)
        [DllImport (LIBNAME)]
        private static extern void core_Core_setUseIPP_1NotExact_10 (bool flag);
